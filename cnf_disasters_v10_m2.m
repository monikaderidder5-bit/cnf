...
% - remove 2 first months of observations
...
mkdir('figures/cnf_disasters_v10_m2')

%% SECTION 1: disasters INSTRUMENT VAR
%------------------------------------------------------------------
% Load data
[disasters_xlsdata, disasters_xlstext] = xlsread('data/data_disasters_v10_m2.xlsx','Sheet1');
...
figure;
bar(time, disaster)
SaveFigure('figures/cnf_disasters_v10_m2/EMDAT',2)
...
SaveFigure('figures/cnf_disasters_v10_m2/IRFs_disasters1', 2);
clf('reset')
...
SaveFigure('figures/cnf_disasters_v10_m2/IRFs_disasters2', 2);
clf('reset')
...
SaveFigure('figures/cnf_disasters_v10_m2/IRFs_u1', 2);
clf('reset')
...
xlim([1 MP_VARopt.nsteps]);
SaveFigure('figures/cnf_disasters_v10_m2/cnf_u1', 2);
clf('reset')
...
SaveFigure('figures/cnf_disasters_v10_m2/IRFs_u2', 2);
clf('reset')
...
xlim([1 MP2_VARopt.nsteps]);
SaveFigure('figures/cnf_disasters_v10_m2/cnf_u2', 2);
clf('reset')
...
SaveFigure('figures/cnf_disasters_v10_m2/IRFs_u3', 2);
clf('reset')
...
xlim([1 MP3_VARopt.nsteps]);
SaveFigure('figures/cnf_disasters_v10_m2/cnf_u3_FINAL', 2);
clf('reset')
...
SaveFigure('figures/cnf_disasters_v10_m2/IRFs_u4', 2);
clf('reset')
...
xlim([1 MP4_VARopt.nsteps]);
SaveFigure('figures/cnf_disasters_v10_m2/cnf_u4', 2);
clf('reset')
...
xlim([1 MP_VARopt.nsteps]);
SaveFigure('figures/cnf_disasters_v10_m2/regs', 2);
clf('reset')
...
title([MP_Xvnames_long{11} ' to disaster shock'], 'FontWeight', 'bold', 'FontSize', 10); 
xlim([1 MP_VARopt.nsteps]);
SaveFigure('figures/cnf_disasters_v10_m2/cnf_u1u3', 2);
clf('reset')
