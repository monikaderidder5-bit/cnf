...
% - remove 4 first months of observations
...
mkdir('figures/cnf_disasters_v10_m4')

%% SECTION 1: disasters INSTRUMENT VAR
%------------------------------------------------------------------
% Load data
[disasters_xlsdata, disasters_xlstext] = xlsread('data/data_disasters_v10_m4.xlsx','Sheet1');
...
time = datetime(2000,5,1):calmonths(1):datetime(2019,12,1);

figure;
bar(time, disaster)
SaveFigure('figures/cnf_disasters_v10_m4/EMDAT',2)
